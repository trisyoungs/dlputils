...
!	Calculate the mean square displacement of molecules (COM)
	...
	call calc_com
	do n=1,s_nmols(1)
	  write(6,"(a,i3,a,3f15.10)") "COM ",n," = ",comx(1,n),comy(1,n),comz(1,n)
	end do
	...
	do s1=1,nspecies
	  do m1=1,s_nmols(s1)
	    ...
	    dz(count1) = lastz(count1) - tz
	     write(6,"(a,i3,a,3f15.10)") "Delta ",m1," = ",dx(count1),dy(count1),dz(count1)
	...
	do n=1,nframes
	  ...
	  do s1=1,nspecies
	    do m1=1,s_nmols(s1)
	      ...
	      ! Increment msd array
	      write(6,"(a,i4,a,i4,f15.10)") "MSD ADD, bin ",nframes-(n-1)," mol ",m1,rij2
